    ...
    <div className="input-subsection">
      <form action="">
        <label htmlFor="school-name">School name:
          <input type="text" id="school-name" name="school-name" placeholder="University of Wonderland" />
        </label>
        <label htmlFor="title-of-study">
          College Degree:
          <select name="title-of-study" id="title-of-study" style={{width: "100%", padding: "3px"}}>
